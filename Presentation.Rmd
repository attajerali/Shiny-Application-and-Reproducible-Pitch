...
- The application is running on (https://attajerali.shinyapps.io/Shiny-application-project/)

- ui.R, and Server.R Code in my github repository (https://github.com/attajerali/Shiny-Application-and-Reproducible-Pitch)
